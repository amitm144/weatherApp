...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class Material3LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final Material3AdaptiveLibraryAccessors laccForMaterial3AdaptiveLibraryAccessors = new Material3AdaptiveLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at material3.adaptive
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Material3AdaptiveLibraryAccessors getAdaptive() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMaterial3AdaptiveLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class Material3AdaptiveLibraryAccessors extends SubDependencyFactory {
        private final Material3AdaptiveNavigationLibraryAccessors laccForMaterial3AdaptiveNavigationLibraryAccessors = new Material3AdaptiveNavigationLibraryAccessors(owner);

        public Material3AdaptiveLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at material3.adaptive.navigation
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Material3AdaptiveNavigationLibraryAccessors getNavigation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMaterial3AdaptiveNavigationLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class Material3AdaptiveNavigationLibraryAccessors extends SubDependencyFactory {

        public Material3AdaptiveNavigationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("material3.adaptive.navigation.suite");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: material3AdaptiveNavigationSuite (1.0.0-alpha06)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
